  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.primary }]} edges={['top']}>
      ...
      <View style={[styles.header, { backgroundColor: colors.primary }]}>
        ...
        >
          <Ionicons name="search" size={16} color={focused ? colors.primary : '#93959F'} />
          <TextInput
            ref={inputRef}
          ...
          {query.length > 0 && (
            <TouchableOpacity onPress={() => setQuery('')}>
              <Ionicons name="close" size={15} color="#93959F" />
            </TouchableOpacity>
          )}
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  searchInput: {
    flex: 1, fontSize: 13, padding: 0, margin: 0, fontFamily: FontFamily.regular,
  },
  scroll: { flex: 1 },
  section: {
