...
const styles = StyleSheet.create({
  ...
  browseBtn: { paddingHorizontal: 28, paddingVertical: 14, borderRadius: 10 },
  ...
  qtyRow: {
    ...
    paddingHorizontal: 6, paddingVertical: 5, gap: 8,
  },
  qtyBtn: { padding: 1 },
  qtyVal: {
  ...
  placeBtn: {
    flex: 1, borderRadius: 10, paddingVertical: 15, alignItems: 'center',
    shadowColor: '#FC2D7C', shadowOffset: { width: 0, height: 4 },
