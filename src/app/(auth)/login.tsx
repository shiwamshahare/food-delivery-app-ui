...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (!success) setError('Invalid credentials. Try com.shahare@gmail.com / password');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* <View style={[styles.hintBox, { backgroundColor: isDark ? '#0d1f33' : '#EEF5FF' }]}>
                    <Text style={[styles.hintText, { color: colors.textSecondary }]}>
                        Demo: com.shahare@gmail.com / password
                    </Text>
                </View> */}
...
const styles = StyleSheet.create({
    ...
    heroTitle: { fontSize: 30, fontFamily: FontFamily.black, color: '#fff', letterSpacing: -0.5 },
    heroSub: { fontSize: 14, color: 'rgba(255,255,255,0.88)', marginTop: 3, fontFamily: FontFamily.semiBold },
    ...
    fieldLabel: { fontSize: 12, fontFamily: FontFamily.bold, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 },
    input: {
        borderWidth: 1.5,
        borderRadius: 10,
